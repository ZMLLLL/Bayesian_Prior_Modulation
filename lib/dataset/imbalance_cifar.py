# To ensure fairness, we use the same code in LDAM
# (https://github.com/kaidic/LDAM-DRW) to produce long-tailed CIFAR datasets.
...
class IMBALANCECIFAR10(torchvision.datasets.CIFAR10):
    ...
    def get_weight(self, annotations, num_classes):
        ...
        class_weight = [max_num / (i**self.cfg.TRAIN.SAMPLER.WEIGHTED_SAMPLER.RATIO)
                        for i in num_list]
