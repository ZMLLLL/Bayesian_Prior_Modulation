...
_C.DATASET.IMBALANCECIFAR.RATIO = 1.0
_C.DATASET.IMBALANCECIFAR.RANDOM_SEED = 0

# ----- MPL_AUG BUILDER -----
_C.MPL_AUG = CN()
_C.MPL_AUG.ENABLE = False
_C.MPL_AUG.INPUT_DIM = 64
_C.MPL_AUG.OUTPUT_DIM = 64
_C.MPL_AUG.HIDDEN_DIM = 64
_C.MPL_AUG.LAYER_NUM = 5

# ----- CON_AUG BUILDER -----
_C.CON_AUG = CN()
_C.CON_AUG.ENABLE = False
_C.CON_AUG.LAYER_NUM = 5
